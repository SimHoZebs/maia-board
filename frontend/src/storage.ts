...
export const KEYS = { settings: 'maia-board.settings.v1', current: 'maia-board.current-game.v1', saved: 'maia-board.saved-games.v1', analysis: 'maia-board.analysis.v1', snapshot: 'maia-board.analysis-snapshot.v1', feedback: 'maia-board.feedback.v1', playVerdict: 'maia-board.play-verdict.v1', badgeLoading: 'maia-board.badge-loading.v1', coordinatesOnSquares: 'maia-board.coordinates-on-squares.v1', boardOrientation: 'maia-board.board-orientation.v1', bestLineWindow: 'maia-board.best-line-window.v1', arrows: 'maia-board.arrows.v1', arrowBasis: 'maia-board.arrow-basis.v1' };
